...
let generousPeops = runners.filter(runner => runner.donation > 200);
...
let emails = [];
generousPeops.forEach(peop => { emails.push(({
...
let runnerCount = runners.reduce((accumulator, currentValue) => {
